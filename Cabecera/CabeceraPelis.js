(function () {
    ...
    const searchIconURL = "https://i.ibb.co/sJJfRtns/Busqueda-Peliculas.png"; // URL válida del ícono de búsqueda
    ...
    Object.assign(searchIcon.style, {
        width: "180px",
        height: "50px",
        backgroundImage: `url('${searchIconURL}')`, // Ruta válida del ícono
    ...
    // Redirigir al buscador al presionar Enter
    searchIcon.addEventListener("keydown", (event) => {
        if (event.key === "Enter") {
            window.location.href = "go:buscador"; // Redirección al buscador
        }
    });
    ...
    searchIcon.addEventListener("click", () => {
        if (touchTimeout === null) {
            ...
            // Segundo toque: redirigir al buscador
